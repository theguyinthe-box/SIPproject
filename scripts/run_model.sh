...
python prepare_data/preparing_faces_parallel.py --mode crop --root_path ../shared/Camera --random_shift 0.05
...
LANG=en_US.utf8 python inversion/scripts/inference_editing.py \
--output_path ../shared/test \
--checkpoint_path pretrained_models/restyle_e4e_ffhq.pt \
--data_path ../shared/Camera_aligned \
--test_batch_size 4 \
--test_workers 4 \
--n_iters_per_batch 3 \
